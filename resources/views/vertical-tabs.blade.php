...
>
        ...
        <div class="flex items-center gap-2 font-medium">
            <template x-for="tab in $el.parentElement.querySelectorAll('[data-tab-id]')" :key="tab.dataset.tabId">
                <div x-show="tab.dataset.tabId === activeTab" class="flex items-center gap-2" style="display: none;">
                    <div x-html="tab.querySelector('[data-tab-icon]')?.innerHTML || ''" class="text-primary-500 dark:text-primary-400"></div>
    ...
    >
        <!-- Backdrop overlay -->
        <div
            class="absolute inset-0 bg-gray-900/50 dark:bg-gray-950/80 backdrop-blur-sm"
